...
frappe.ui.form.on("Customer", {
	...
	customer_primary_address: function(frm){
		if(frm.doc.customer_primary_address){
			frappe.call({
				...
				callback: function(r) {
					frm.set_value("primary_address_html", r.message);
				}
			});
		}
		if(!frm.doc.customer_primary_address){
			frm.set_value("primary_address_html", "");
		}
	},
	...
	// 	if(frm.doc.customer_primary_address){
	// 		frappe.call({
    //             method: "erpnext.selling.doctype.customer.customer.create_primary_address",
    //             args: {
    //                 doctype: 'Item',
    //                 item_class: frm.doc.item_class
    //             },
    //             callback: function(r) {
	...
	refresh: function(frm) {
		frm.trigger("customer_primary_address");
		...
		frm.toggle_display(['address_html','contact_html', 'primary_address_html'], !frm.doc.__islocal);

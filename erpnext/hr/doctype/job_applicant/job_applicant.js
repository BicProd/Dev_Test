...
frappe.ui.form.on("Job Applicant", {
	...
	before_save: function(frm){
		frm.doc.applicant_education = [];
		erpnext.utils.map_current_doc({
			method: "erpnext.hr.doctype.job_applicant.job_applicant.fetch_applicant_template",
			source_name: frm.doc.job_application_form,
			frm: frm
		});

	},
	after_save: function(frm){
		frm.doc.applicant_experience = [];
		erpnext.utils.map_current_doc({
			method: "erpnext.hr.doctype.job_applicant.job_applicant.fetch_applicant_template1",
			source_name: frm.doc.job_application_form,
			frm: frm
		});

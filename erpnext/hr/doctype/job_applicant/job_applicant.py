...
@frappe.whitelist()
def fetch_applicant_template(source_name, target_doc=None):
	target_doc = get_mapped_doc("Job Application Form", source_name, {
		"Job Application Form": {
			"doctype": "Job Applicant",
		},
		"Education": {
			"doctype": "Applicant Education",
		}
	}, target_doc)
...
@frappe.whitelist()
def fetch_applicant_template1(source_name, target_doc=None):
	target_doc = get_mapped_doc("Job Application Form", source_name, {
		"Job Application Form": {
			"doctype": "Job Applicant",
		},
		"Job Experience": {
			"doctype": "Applicant Experience",
		}
	}, target_doc)

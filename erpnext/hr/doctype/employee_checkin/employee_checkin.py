...
def mark_attendance_and_link_log(logs, attendance_status, attendance_date, working_hours=None, late_entry=False, early_exit=False, in_time=None, out_time=None, shift=None, late_calculation="00:00:00"):
	...
	if attendance_status == 'Skip':
		...
		if not frappe.db.exists('Attendance', {'employee':employee, 'attendance_date':attendance_date, 'docstatus':('!=', '2')}):
			doc_dict = {
				...
				'shift': shift,
				"late_calculation" : late_calculation,
